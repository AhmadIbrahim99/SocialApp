...
import 'package:social_app/admin/admin_dash.dart';
import 'package:social_app/admin/cubit/cubit.dart';
import 'package:social_app/admin/cubit/state.dart';
      ...
      listener: (context, state) async{
        ...
        if(state is AdminUpdatePostSuccessState){
          ...
          Timer(Duration(seconds: 1),(){
            showToast(message: "سيتم نقلك للشاشة الرئيسية خلال ثواني", states: ToastStates.SUCCESS);
          });
              ...
              TextButton(
                onPressed: () {
                  if(text.text.isEmpty && cubit.postImage ==null){
                    showToast(message: "أدخل نص أو أضف صورة", states: ToastStates.WARNING, toastLength: Toast.LENGTH_LONG);
                  }else{

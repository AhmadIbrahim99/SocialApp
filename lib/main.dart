...
import 'package:social_app/admin/cubit/cubit.dart';
...
Future<void> firebaseBackgroundHandler(RemoteMessage message)async{
  ...
  showToast(message: 'BackGround', states: ToastStates.SUCCESS,);
...
Future<void> main() async {
  ...
  FirebaseMessaging.onMessage.listen((event) {
    ...
    showToast(message: 'onMessage', states: ToastStates.SUCCESS,);
  }).onError((handleError){
    print('error');
  });
  ...
  FirebaseMessaging.onMessageOpenedApp.listen((event) {
    print(event.data.toString());
    showToast(message: 'onMessageOpenedApp', states: ToastStates.SUCCESS,);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => AppCubit()..changeAppMode(boolShared: isDark)),
        BlocProvider(create: (context) => SocialCubit()..getUserData()..getUsers()..getPosts()),

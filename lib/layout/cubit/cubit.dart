...
import 'package:social_app/module/feed/feeds_screen.dart';
import 'package:social_app/module/settings/settings_screen.dart';
import 'package:social_app/module/userscreen/user_screen.dart';
...
//my work create post and handle
  ...
  void addPostComments(String id) {
    FirebaseFirestore.instance.collection('posts').doc(id)
        .update(
        {'commentsList': commentsList, 'comments': commentsList.length ?? 0})
        .then((value) {
          posts[posts.indexWhere((element) => element.postId == id)].comments = commentsList.length;
          posts[posts.indexWhere((element) => element.postId == id)].commentsList = commentsList;

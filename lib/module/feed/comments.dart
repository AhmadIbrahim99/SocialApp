...
class CommentsScreen extends StatelessWidget {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${SocialCubit.get(context).commentsList.length ?? 0} تعليق",
                                          style: Theme.of(context)
                                              .textTheme
                                              .caption,
                                        ),
                          ...
                          Container(
                            ...
                            child: ListView.separated(
                                ...
                                itemBuilder: (context, index) => buildComment(
                                    SocialCubit.get(context).commentsList[index]),
                                separatorBuilder: (context, index) => Divider(),
                                itemCount: SocialCubit.get(context).commentsList.length),
                        ...
                        defaultFormField(
                            ...
                            fSuffix: (){
                              if(commentController.text != ""){
                                SocialCubit.get(context).commentsList.add(commentController.text);
                                SocialCubit.get(context).addPostComments(postsModel.postId!);
  ...
  Widget buildComment(String comment) => Container(
      height: 50.0,
      child: Text('$comment',maxLines: 2, overflow: TextOverflow.ellipsis,));
}

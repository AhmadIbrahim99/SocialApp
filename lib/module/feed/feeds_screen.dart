...
import 'package:social_app/module/feed/comments.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              InkWell(
                onTap: (){
                 int ind = SocialCubit.get(context).users.indexWhere((element) => element.uId == postModel.uId);
                 UserModel us = SocialCubit.get(context).users[ind];
                  navigateTo(context, ProfileScreen(user: us,));
                },
                child: Row(
                  children: [
                    CircleAvatar(
              ...
              Row(
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        SocialCubit.get(context).getPostComments(postModel.postId!);
                        navigateTo(context, CommentsScreen(postsModel: postModel,));
                      },
                      child: Row(
                        children: [
                          CircleAvatar(

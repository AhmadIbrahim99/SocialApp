          ...
          Row(
            children: [
              ...
              InkWell(
                ...
                onTap: () {
                  int i =  SocialCubit.get(context).posts.indexWhere((element) => postModel.postId==element.postId);

                  if (SocialCubit.get(context).posts[i].usersIdLiked!.contains(SocialCubit.get(context).userModel!.uId)) {

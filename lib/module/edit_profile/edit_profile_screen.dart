              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    if(SocialCubit.get(context).image != null || SocialCubit.get(context).coverImage != null )
                    Row(
                      children: [
                        ...
                        Expanded(child: Column(
                          children: [
                            ...
                            if(state is SocialUpdateLoadingImageCoverState)
                              SizedBox(height: 5.0,),
                            if(state is SocialUpdateLoadingImageCoverState)
                        ...
                        if(SocialCubit.get(context).image != null)
                          Expanded(child: Column(
                            children: [
                              ...
                              if(state is SocialUpdateLoadingImageProfileState)
                                SizedBox(height: 5.0,),
                              if(state is SocialUpdateLoadingImageProfileState)
                                LinearProgressIndicator(),
                            ],
